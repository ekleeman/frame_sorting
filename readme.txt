...
3. File setup:
	A. "XX_results.csv": Rows (0 to (# of arenas*2)), columns 0 to 2 - Data from FIJI noting the center of object A and object B (in that order), in order by arena.
			     ...
			     Rows (1 to # of arenas), columns 3 to 5 - 
In column 3, the list of the animals (a.k.a. arenas) active in this 
video. In the adjoining column for each, the video frame at which 
exploration starts. In the following column, the frame at which 
exploration ends for each arena.
